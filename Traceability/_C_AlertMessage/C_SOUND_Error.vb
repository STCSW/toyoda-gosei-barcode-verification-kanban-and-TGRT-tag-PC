...
Public Class C_SOUND_Error
    ...
    Private Shared confirmSoundPath As String = Path.Combine(System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().GetName().CodeBase) & "\Sound\", "Error.wav")
